...
def findBbox(yolov5_wrapper, imageLeft, imageRight):
    bboxesLeft = vizLeft(yolov5_wrapper, imageLeft)
    bboxesRight = vizRight(yolov5_wrapper, imageRight)
    return bboxesLeft, bboxesRight
...
class warmUpThread(threading.Thread):
    ...
    def run(self):
        batch_image_raw, bbox, use_time = self.yolov5_wrapper.infer(self.yolov5_wrapper.get_raw_image_zeros())
